...
_group LASSO_ regresso. Group LASSO is a way to combine regression, validation,
...
across _n_ fold validation (these values are non-deterministic, and will
change slightly across different runs of this code)
